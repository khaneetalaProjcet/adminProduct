          ...
          <v-tabs-window v-model="tab">
            <v-tabs-window-item value="one">
              ...
              <v-card title="معاملات در انتظار بررسی صندوق طلا">
                <ul class="listGuide">
                  <li>
                    معاملاتی که توسط کارشناس به صورت تلفنی ثبت شده‌اند و در حال انتظار برای پرداخت و تأیید حسابداری
                    هستند.
            ...
            <v-tabs-window-item value="three">
              <v-row class="filter my-3">
                ...
                <v-col cols="12" md="3">
                  <div class="w-100 d-flex justify-end">
                    <v-btn prepend-icon="ri-loop-left-line" variant="tonal" block @click="SubmitFilter('failed')">به روز
                      رسانی</v-btn>
                  </div>
                </v-col>
                <v-col cols="12" md="3">
              ...
              <v-card title="معاملات رد شده صندوق طلا">
                ...
                <v-data-table :headers="rejectAccountingReviewHeader" :items="rejectAccountingReviewData"
        ...
        <div class="form-box">
          <v-form ref="form" @submit.prevent="">
            ...
            <div class="d-flex justify-space-between">
              <v-btn type="submit" size="large" class="my-2" color="#388E3C" :loading="AccountingReviewSubmitLoading"
                @click="submitAccountingReview">تایید
                پرداخت</v-btn>
              <v-btn type="submit" size="large" class="my-2" color="error" :loading="AccountingReviewRejectLoading"
                @click="rejectAccountingReview">رد
                پرداخت</v-btn>
            </div>
          </v-form>
        </div>
